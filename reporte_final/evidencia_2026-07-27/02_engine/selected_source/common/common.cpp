...
bool gpt_params_find_arg(int argc, char ** argv, const std::string & arg, gpt_params & params, int & i, bool & invalid_param) {
    ...
    if (arg == "--slot-affinity-by-repo-scope") {
        params.slot_affinity_by_repo_scope = true;
        return true;
    }
    if (arg == "-pps") {
    ...
    if (arg == "--ctx-checkpoints-safe-boundary-only") {
        params.ctx_checkpoints_safe_boundary_only = true;
        return true;
    }
...
void gpt_params_print_usage(int /*argc*/, char ** argv, const gpt_params & params) {
    ...
    options.push_back({ "*",           "--ctx-checkpoints-safe-boundary-only", "create recurrent checkpoints only at safe user_start/user_end boundaries; interval sets pending boundary cadence (default: disabled)"});
    ...
    options.push_back({ "server",      "       --slot-affinity-by-repo-scope",
                                                                        "enable strict repo-scope slot affinity for multi-agent workflows (default: disabled)" });
